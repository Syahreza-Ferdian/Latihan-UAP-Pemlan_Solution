public class Cengkeh extends Tanaman implements TreatmentInterface {
    ...
    public String getStatus(){
        // Code here
        return alreadyPesticide() ? "Pesticide" : "Normal";
    }
    ...
    public double dailySell(){
        // Code here
        return this.getArea() * resultInKgPerDay * cengkehPrice;
    }
    ...
    @Override public String toString(){
        return super.toString() + String.format("%-25s: %s kg (per hektar)\n%-25s: Rp. %,3.2f (per kg)\n%-25s: Rp. %,3.2f (per hari)\n%-25s: Rp. %,3.2f (per hari)\n%-25s: %s", 
        "Cengkeh/hari", Double.toString(resultInKgPerDay), "Harga Pasar", cengkehPrice, "Penjualan", dailySell(), "Profit", dailyProfit(), "Status", getStatus());
    }
